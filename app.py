...
.block-container { background: #f4f6fb !important; }

/* ── KPI row — 7 cards one line ── */
.krow { display:grid; grid-template-columns:repeat(7,1fr); gap:10px; margin-bottom:28px; }
.kcell {
    background:white; border:1px solid #e5e7eb; border-radius:10px;
    padding:16px 14px 13px; position:relative;
...
# ════════════════════════════════════════════════════════════
# SIDEBAR — black background, FILTERS on top, VIEWS below
# ════════════════════════════════════════════════════════════
with st.sidebar:
    # Brand header
    st.markdown(f"""
    <div style="background:#0f0f0f;padding:18px 16px 14px;
                border-bottom:1px solid #2a2a2a;">
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px">
        <div style="background:#1877F2;border-radius:8px;width:30px;height:30px;
                    display:flex;align-items:center;justify-content:center">
          {META_SVG}
        </div>
        <div>
          <div style="color:white;font-size:0.92rem;font-weight:700;line-height:1.2">Meta Ads</div>
...
st.markdown(f"""
<div class="topbar">
  <div class="tb-brand">{META_SVG}
    <span class="tb-brand-name">Meta Ads</span>
  </div>
  <div class="tb-sep"></div>
  <span class="tb-pagetitle">{page_titles[page]}</span>
  <div class="tb-right">

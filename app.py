...
/* KPI cards */
.krow{display:grid;grid-template-columns:repeat(7,1fr);gap:10px;margin-bottom:26px}
...
.kl{font-size:0.65rem;color:#9ca3af;font-weight:600;
...
.tl{font-size:0.65rem;color:#9ca3af;font-weight:600;
...
# ═══════════════════════════════════════════════════════════════
# LAYOUT: black left nav (col) + main content (col)
# ═══════════════════════════════════════════════════════════════
...
with nav:
    ...
    # Brand
    st.markdown(f"""
    <div style="background:#111111;padding:18px 16px 14px;
                border-bottom:1px solid #333333;margin-bottom:4px">
      <div style="display:flex;align-items:center;gap:8px">
        ...
        <div>
          ...
          <div style="color:#888888;font-size:0.72rem">Dashboard</div>
        </div>
      </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    # VIEWS
    st.markdown('<span class="nav-label">Views</span>', unsafe_allow_html=True)
...
with main:
    ...
    <div style="background:#1877F2;height:50px;display:flex;align-items:center;
      ...
      <span style="width:1px;height:22px;background:rgba(255,255,255,0.3);display:inline-block"></span>
      ...
      <div style="background:white;border-radius:5px;padding:3px 8px">
        <img src="data:image/png;base64,{LS_B64}" height="22" style="object-fit:contain;display:block">
      </div>
    </div>
    """, unsafe_allow_html=True)
